...
export default function Home() {
    ...
    return (
        <>
        <Layout headerStyle={3} footerStyle={3} breadcrumbTitle="Product Details">
                    ...
                    <div className="col-lg-6 col-xl-6">
                        ...
                        <div className="product-details__social">
                            ...
                            <div className="product-details__social-link">
                                ...
                                <Link href="https://www.instagram.com/mobihubmk/" target="_blank"><span className="fab fa-instagram"></span></Link>
                            </div>
                        </div>
                    </div>
                </div>
